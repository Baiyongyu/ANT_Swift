...
@interface AdvertScrollViewOneCell : UICollectionViewCell
@property (nonatomic, strong) UILabel *tipsLabel;
@end

@implementation AdvertScrollViewOneCell
...
#pragma mark - - - AdvertScrollViewTwoCell
@interface AdvertScrollViewTwoCell : UICollectionViewCell
@property (nonatomic, strong) UILabel *topLabel;
@property (nonatomic, strong) UIImageView *signImageView;
@property (nonatomic, strong) UILabel *bottomLabel;
@end

@implementation AdvertScrollViewTwoCell
...
#pragma mark - - - AdvertScrollView
@interface AdvertScrollView () <UICollectionViewDelegate, UICollectionViewDataSource>
...
- (void)initialization {
    ...
    [self addTimer];
    self.advertScrollViewStyle = AdvertScrollViewStyleNormal;
}
...
- (void)setupCollectionView {
    ...
    // 注册
    [_collectionView registerClass:[AdvertScrollViewOneCell class] forCellWithReuseIdentifier:advertScrollViewOneCell];
    [_collectionView registerClass:[AdvertScrollViewTwoCell class] forCellWithReuseIdentifier:advertScrollViewTwoCell];
...
- (void)layoutSubviews {
    ...
    // 设置图片尺寸
    if (self.advertScrollViewStyle == AdvertScrollViewStyleTwo) { // 左边提示图片根据图片尺寸距离顶部、底部间距为 5
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    if (self.advertScrollViewStyle == AdvertScrollViewStyleTwo) {
        AdvertScrollViewTwoCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:advertScrollViewTwoCell forIndexPath:indexPath];
        ...
        AdvertScrollViewOneCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:advertScrollViewOneCell forIndexPath:indexPath];
